...
public partial class Rod : Node3D
{
	...
	private const float LATERAL_SPEED = 7.5f;  // Erhöht von 2.0 für schnellere Auf/Ab-Bewegung
	...
	private MqttInputManager _inputManager;
